...
import { FiLink } from "react-icons/fi"; // Assuming you're using react-icons for the link icon
        ...
        <div>
          <div className="relative z-10 flex flex-col gap-6">
            {content.map((item: ExperienceContent, index) => (
              <div
                key={index}
                className="p-4 sm:p-8 bg-black/20 backdrop-blur-sm rounded-lg overflow-hidden"
              >
